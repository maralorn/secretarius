  ...
  module.exports = function(c) {
    ...
    printTable = function(tablename, table) {
      ...
      for (name in table) {
        ...
        if (column["default"] != null) line.push(" default " + column["default"]);
        if ((column["null"] != null) && !column["null"]) line.push(" not null");
        if ((column.unique != null) && column.unique) line.push(" unique");
      ...
      if (table._append != null) console.log(table._append);
      return console.log('');
    };
