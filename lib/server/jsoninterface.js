  ...
  module.exports = function(app, model) {
    ...
    Parser = (function() {
      ...
      Parser.prototype.parse = function(req, res, next) {
        var _this = this;
        return (function __1(_) { var args, handler, handlerobj, method, object, result, _i, _len, _ref; var __frame = { name: "__1", line: 70 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {

            util.debug(req.method, req.url, req.query, req.body); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
                  ...
                  if ((handler == null)) {
                    ...
                    if ((handler.before != null)) { return (function __$__1(_) {
                        return handler.before(__cb(_, __frame, 21, 21, function ___(__0, __1) { var __2 = __1; return (function __$__1(__then) { if (__2) { var __3 = __1; return _(null, __3); } else { __then(); } ; })(function __$__1() { return _(null, []); }); }, true), req); })(__cb(_, __frame, -69, 7, function ___(__0, __2) { args = __2; __then(); }, true)); } else { __then(); } ; })(function __$__1() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {




                          return (function(cb) { return method.apply(object, [cb,].concat(args)); })(__cb(_, __frame, 26, 14, __then, true)); }); })(function ___(error, __result) { __tryCatch(_, function __$__1() { if (error) {
                          ...
                          if ((handler.after != null)) {
                            return handler.after(__cb(_, __frame, 35, 23, function ___(__0, __3) { result = __3; __then(); }, true), result); } else { __then(); } ; })(function __$__1() {
    ...
    parser = new Parser;
    afterOnPost = function afterOnPost__1(_, ans) { var __frame = { name: "afterOnPost__1", line: 124 }; return __func(_, this, arguments, afterOnPost__1, 0, __frame, function __$afterOnPost__1() {
        return _(null, {
          id: ans }); }); };
    ...
    parser.registerMethods({
      after: function after__2(_, ans) { var __frame = { name: "after__2", line: 137 }; return __func(_, this, arguments, after__2, 0, __frame, function __$after__2() {
          return _(null, {
            type: ans }); }); },
      ...
      before: function before__3(_, req) { var __frame = { name: "before__3", line: 144 }; return __func(_, this, arguments, before__3, 0, __frame, function __$before__3() {
          return _(null, [req.body.status,]); }); },

      method: model.Information.prototype.setStatus
    }, {
      before: ref = function ref__4(_, req) { var __frame = { name: "ref__4", line: 149 }; return __func(_, this, arguments, ref__4, 0, __frame, function __$ref__4() {
      ...
      before: function before__5(_, req) { var __frame = { name: "before__5", line: 158 }; return __func(_, this, arguments, before__5, 0, __frame, function __$before__5() {
      ...
      before: con = function con__6(_, req) { var __frame = { name: "con__6", line: 167 }; return __func(_, this, arguments, con__6, 0, __frame, function __$con__6() {
      ...
      before: function before__7(_, req) { var __frame = { name: "before__7", line: 184 }; return __func(_, this, arguments, before__7, 0, __frame, function __$before__7() {
          return _(null, [req.body.description,req.body.referencing,req.body.parent,]); }); },

      after: afterOnPost,
      method: model.Project.prototype.create
    }, {
      before: function before__8(_, req) { var __frame = { name: "before__8", line: 190 }; return __func(_, this, arguments, before__8, 0, __frame, function __$before__8() {
          return _(null, [((req.body.deadline !== "") ? new Date(req.body.deadline) : null),]); }); },

      method: model.Task.prototype.setDeadline
    }, {
      before: function before__9(_, req) { var __frame = { name: "before__9", line: 195 }; return __func(_, this, arguments, before__9, 0, __frame, function __$before__9() {
          return _(null, [req.body.description,]); }); },

      method: model.Task.prototype.setDescription
    }, {
      before: function before__10(_, req) { var __frame = { name: "before__10", line: 200 }; return __func(_, this, arguments, before__10, 0, __frame, function __$before__10() {
      ...
      before: function before__11(_, req) { var __frame = { name: "before__11", line: 209 }; return __func(_, this, arguments, before__11, 0, __frame, function __$before__11() {
          return _(null, [req.body.description,req.body.list,req.body.referencing,req.body.project,]); }); },

      after: afterOnPost,
      method: model.Asap.prototype.create
    }, {
      before: function before__12(_, req) { var __frame = { name: "before__12", line: 215 }; return __func(_, this, arguments, before__12, 0, __frame, function __$before__12() {
          return _(null, [req.body.project,]); }); },

      method: model.Asap.prototype.setProject
    }, {
      before: listfn = function listfn__13(_, req) { var __frame = { name: "listfn__13", line: 220 }; return __func(_, this, arguments, listfn__13, 0, __frame, function __$listfn__13() {
          return _(null, [req.body.list,]); }); },

      method: model.Asap.prototype.setList
    }, {
      before: name = function name__14(_, req) { var __frame = { name: "name__14", line: 225 }; return __func(_, this, arguments, name__14, 0, __frame, function __$name__14() {
